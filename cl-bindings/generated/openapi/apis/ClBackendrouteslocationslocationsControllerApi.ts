...
/**
 * ClBackendrouteslocationslocationsControllerApi - interface
 * 
 * @export
 * @interface ClBackendrouteslocationslocationsControllerApiInterface
 */
export interface ClBackendrouteslocationslocationsControllerApiInterface {
    /**
     * 
     * @param {CreateLocation} createLocation 
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof ClBackendrouteslocationslocationsControllerApiInterface
     */
 ...
 * 
 */
export class ClBackendrouteslocationslocationsControllerApi extends runtime.BaseAPI implements ClBackendrouteslocationslocationsControllerApiInterface {
